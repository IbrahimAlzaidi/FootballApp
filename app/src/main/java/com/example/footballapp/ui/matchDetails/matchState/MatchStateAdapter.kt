...
import com.example.footballapp.model.response.fixtureAllData.MatchStatisticInformation
...
class MatchStateAdapter(items: List<MatchResultData>) :
    BaseAdapter<MatchResultData>(items,null, R.layout.match_statictis_items) {
}
