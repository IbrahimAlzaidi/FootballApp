...
class Repository {
    ...
    // function to get teamInfo information
    ...
    fun getMatchLineup(matchId: Int): Flow<State<LineupInfoResponse?>> =
        wrapWithFlow { Api.apiService.getMatchLineup(matchId) }

    // function to get playerInfo statistic
    ...
    // function to get playerInfo trophies
    ...
    // function to search leagueInfo by leagueInfo name
