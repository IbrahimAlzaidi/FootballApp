...
class ViewModelFactory(private val arg: Int?, private val leagueId: Int?) :
    ViewModelProvider.NewInstanceFactory() {

    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        return when {
            modelClass.isAssignableFrom(ClubDetailsViewModel::class.java) -> ClubDetailsViewModel(
                arg,
                leagueId
            ) as T
            ...
            modelClass.isAssignableFrom(LeagueDetailsViewModel::class.java) -> LeagueDetailsViewModel(
                arg
            ) as T

            modelClass.isAssignableFrom(MatchDetailsViewModel::class.java) -> MatchDetailsViewModel(
                arg
            ) as T

            modelClass.isAssignableFrom(MatchesViewModel::class.java) -> MatchesViewModel(arg) as T

            modelClass.isAssignableFrom(PlayerDetailsViewModel::class.java) -> PlayerDetailsViewModel(
                arg
            ) as T
            ...
            modelClass.isAssignableFrom(ClubInformationViewModel::class.java) -> ClubInformationViewModel(
                arg,
                leagueId
            ) as T
            ...
            modelClass.isAssignableFrom(ClubMatchPlayedViewModel::class.java) -> ClubMatchPlayedViewModel(
                arg
            ) as T
            ...
            modelClass.isAssignableFrom(SubstitutesViewModel::class.java) -> SubstitutesViewModel(
                arg
            ) as T
